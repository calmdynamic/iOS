...
class FolderTypeViewController2: UIViewController, UISearchBarDelegate {
     ...
     override func prepare(for segue: UIStoryboardSegue, sender: Any?)  {
        ...
        if selectedFolderType.getName() != "Default"{
            if segue.identifier == segueIdentfier{
                let folderVC = segue.destination as! FolderViewController3
...
extension FolderTypeViewController2: UICollectionViewDataSource{
...
extension FolderTypeViewController2: UICollectionViewDelegate{
