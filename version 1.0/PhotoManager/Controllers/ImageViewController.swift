...
//        self.tabBarController?.tabBar.isHidden = true
    ...
    override func setEditing(_ editing: Bool, animated: Bool) {
        ...
        ToolBarService.toolbarItemChangeWhenSetEditing(toolbar: toolbar, hashTagBtn: hashTagBtn, deleteButton: deleteButton, downloadBtn: downloadBtn, cameraBtn: cameraBtn, importBtn: importBtn, moveBtn: moveBtn, navigationItem: navigationItem, editing: editing)
...
extension ImageViewController: UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ToolBarService.toolbarItemWhenCellIsClickedAndDeclicked(selectedFolder:self.selectedFolder, collectionView: self.collectionView, hashTagBtn: self.hashTagBtn, deleteButton: self.deleteButton, cameraBtn: self.cameraBtn, downloadBtn: self.downloadBtn, importBtn: importBtn, moveBtn: moveBtn)
    }
