...
//                DownloadService.fetchSpecificData(category: category, subCategory: subCategory, snap: snap, image: imageArray, activityIndicator: activityIndicator)
    ...
    private static func fetchSpecificData(category: String, subCategory: String, snap: DataSnapshot, image: ImageArray, activityIndicator: UIActivityIndicatorView){
...
//    }
    ...
    private static func fetchAllData(snap: DataSnapshot, image: ImageArray, activityIndicator: UIActivityIndicatorView){
...
//    }
    ...
    public static func saveDownloadedImage(selectedFolder: Folder, imageArray: ImageArray, tableView: UITableView, controller:UIViewController, indexPath: IndexPath){
        ...
        AlertDialog.showAlertMessage(controller: controller, title: "", message: "Saved Successfully", btnTitle: "Ok")
    ...
    static func fetechAllData(imagesArray: ImageArray, activityIndicator: UIActivityIndicatorView, tableView: UITableView, noDataAvailableLabel: UILabel, controller: UIViewController)
    {
        ...
        if Reachability.isConnectedToNetwork(){
            if Auth.auth().currentUser != nil{
                ...
                AlertDialog.showAlertMessage(controller: controller, title: "Error", message: "You have not signed in your account; you cannot download images", btnTitle: "Ok")
