...
class ToolBarService{
    ...
    public static func toolbarItemWhenCellIsClickedAndDeclicked(selectedFolder: Folder, collectionView:UICollectionView ,hashTagBtn: UIBarButtonItem, deleteButton: UIBarButtonItem, cameraBtn: UIButton, downloadBtn: UIButton, importBtn: UIBarButtonItem, moveBtn: UIBarButtonItem){
        //let numOfSelection = collectionView.indexPathsForSelectedItems?.count
    ...
    public static func initButtons(deleteButton: UIBarButtonItem, hashTagBtn: UIBarButtonItem, importBtn: UIBarButtonItem, moveBtn: UIBarButtonItem){
        deleteButton.isEnabled = false
        hashTagBtn.isEnabled = false
        importBtn.isEnabled = true
        moveBtn.isEnabled = false
    ...
    public static func toolbarItemChangeWhenSetEditing(toolbar: UIToolbar, hashTagBtn: UIBarButtonItem, deleteButton: UIBarButtonItem,downloadBtn: UIButton, cameraBtn:UIButton, importBtn: UIBarButtonItem, moveBtn: UIBarButtonItem, navigationItem:UINavigationItem, editing: Bool){
        navigationItem.hidesBackButton = editing
