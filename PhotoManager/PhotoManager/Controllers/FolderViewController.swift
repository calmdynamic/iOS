    ...
    @IBAction func addFolder(_ sender: UIBarButtonItem) {
        ...
        let confirmAction = UIAlertAction(title: "Add", style: .default) { (_) in
            ...
            if let tempFolderName = folderName?.trimmingCharacters(in: .whitespaces), !UtilityService.shared.isTextEmpty(tempFolderName) {
                ...
                AlertDialog.showAlertMessage(controller: self, title: "Null String Error", message: "We don't accept the empty string; please give your folder a descriptive name", btnTitle: "Confrim")
            }
