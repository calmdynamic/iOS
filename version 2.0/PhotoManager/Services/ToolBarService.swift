...
class ToolBarService{
    ...
    public static func toolbarItemWhenCellIsClickedAndDeclicked(selectedFolder: Folder, collectionView:UICollectionView ,hashTagBtn: UIBarButtonItem, deleteButton: UIBarButtonItem, cameraBtn: UIButton, importBtn: UIBarButtonItem, moveBtn: UIBarButtonItem){
        //let numOfSelection = collectionView.indexPathsForSelectedItems?.count
...
//            downloadBtn.isEnabled = false
    ...
    public static func toolbarItemChangeWhenSetEditing(toolbar: UIToolbar, hashTagBtn: UIBarButtonItem, deleteButton: UIBarButtonItem, cameraBtn:UIButton, importBtn: UIBarButtonItem, moveBtn: UIBarButtonItem, navigationItem:UINavigationItem, editing: Bool){
        navigationItem.hidesBackButton = editing
